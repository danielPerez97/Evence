...
private val PrimaryVariant = Color(android.graphics.Color.parseColor("#f5263238"))
...
val DarkCardViewBackground = Color(android.graphics.Color.parseColor("#f5263238"))
